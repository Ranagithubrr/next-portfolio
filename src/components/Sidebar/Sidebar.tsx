...
import { FaUser, FaTools, FaBriefcase, FaProjectDiagram, FaEnvelope, FaGraduationCap, FaPenNib } from "react-icons/fa";
...
const Sidebar = () => {
  ...
  const handleScroll = () => {
    const sections = ["home", "skills", "education", "experience", "projects", "blog", "contact"];
  ...
  const icons: IconItem[] = [
    ...
    { icon: FaPenNib, label: "Blog", sectionId: "blog" },
